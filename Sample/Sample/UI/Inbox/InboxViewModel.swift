...
internal class InboxViewModel: ObservableObject {
    ...
    internal func presentInboxItem(_ item: ActitoInboxItem) {
    ...
    internal func markItemAsRead(_ item: ActitoInboxItem) {
    ...
    internal func removeItem(_ item: ActitoInboxItem) {
