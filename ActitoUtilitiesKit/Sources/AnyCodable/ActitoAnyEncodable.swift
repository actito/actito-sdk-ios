...
/**
 ...
 The `ActitoAnyEncodable` type forwards encoding responsibilities
 to an underlying value, hiding its specific underlying type.
 You can encode mixed-type values in dictionaries
 and other collections that require `Encodable` conformance
 by declaring their contained type to be `ActitoAnyEncodable`:
 let dictionary: [String: ActitoAnyEncodable] = [
 "boolean": true,
 "integer": 42,
...
extension ActitoAnyEncodable: Equatable {
    public static func == (lhs: ActitoAnyEncodable, rhs: ActitoAnyEncodable) -> Bool {
        ...
        case let (lhs as String, rhs as String):
            return lhs == rhs
        case let (lhs as [String: ActitoAnyEncodable], rhs as [String: ActitoAnyEncodable]):
            return lhs == rhs
        case let (lhs as [ActitoAnyEncodable], rhs as [ActitoAnyEncodable]):
            return lhs == rhs
        default:
            return false
        }
...
extension ActitoAnyEncodable: CustomStringConvertible {
...
extension ActitoAnyEncodable: CustomDebugStringConvertible {
    public var debugDescription: String {
        switch value {
        case let value as CustomDebugStringConvertible:
            return "ActitoAnyEncodable(\(value.debugDescription))"
        default:
            return "ActitoAnyEncodable(\(description))"
        }
    }
}

extension ActitoAnyEncodable: ExpressibleByNilLiteral {}
extension ActitoAnyEncodable: ExpressibleByBooleanLiteral {}
