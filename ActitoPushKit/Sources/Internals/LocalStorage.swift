...
internal enum LocalStorage {
    ...
    internal static var transport: ActitoTransport? {
        get {
            ...
            do {
                ...
                return try decoder.decode(ActitoTransport.self, from: data)
            } catch {
    ...
    internal static var subscription: ActitoPushSubscription? {
        get {
            ...
            do {
                let decoder = JSONDecoder.actito
                return try decoder.decode(ActitoPushSubscription.self, from: data)
            } catch {
