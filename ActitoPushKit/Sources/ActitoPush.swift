...
public protocol ActitoPush: AnyObject, ActitoPushUIApplicationDelegate, ActitoPushUNUserNotificationCenterDelegate {
    // MARK: Properties
    ...
    var delegate: ActitoPushDelegate? { get set }
    ...
    ///
    var transport: ActitoTransport? { get }
    ...
    ///
    var subscription: ActitoPushSubscription? { get }

    /// This property returns a Publisher that can be observed to track changes to the device's push subscription token.
    var subscriptionStream: AnyPublisher<ActitoPushSubscription?, Never> { get }
    ...
    func enableRemoteNotifications(_ completion: @escaping ActitoCallback<Bool>)
    ...
    func disableRemoteNotifications(_ completion: @escaping ActitoCallback<Void>)
    ...
    func isActitoNotification(_ userInfo: [AnyHashable: Any]) -> Bool
    ...
    @available(iOS 16.1, *)
    func registerLiveActivity(_ activityId: String, token: String, topics: [String], _ completion: @escaping ActitoCallback<Void>)
    ...
    @available(iOS 16.1, *)
    func endLiveActivity(_ activityId: String, _ completion: @escaping ActitoCallback<Void>)
