...
public class ActitoMailActionHandler: ActitoBaseActionHandler {
    internal override func execute() {
        ...
        composer.setSubject(ActitoLocalizable.string(resource: .actionMailSubject))
...
extension ActitoMailActionHandler {
