...
internal class InboxViewModel: ObservableObject {
    @Published internal private(set) var items: [ActitoUserInboxItem] = []
    ...
    internal func presentInboxItem(_ item: ActitoUserInboxItem) {
    ...
    internal func markItemAsRead(_ item: ActitoUserInboxItem) {
    ...
    internal func removeItem(_ item: ActitoUserInboxItem) {
    ...
    private func refresh() async throws {
        ...
        let userInboxResponse = try Actito.shared.userInbox().parseResponse(data: response.data!)
