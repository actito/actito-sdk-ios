    ...
    override internal init() {
        ...
        NotificationCenter.default
            ...
            .sink { [weak self] notification in
                ...
                self?.onActitoStatusAuthUpdate(isReady: ready)
            }
    ...
    internal func actitoLaunch() {
        ...
        Task {
            do {
                ...
                Logger.main.error("Actito.shared.launch failed: \(error).")
            }
        }
    }
...
extension HomeViewModel {
    ...
    private func onActitoStatusAuthUpdate(isReady: Bool) {
        if !isReady {
            isDeviceRegistered = false
            return
        }
    ...
    private func registerDevice(accessToken: String, method: HTTPMethod) async throws {
        ...
        guard let deviceId = Actito.shared.device().currentDevice?.id else {
