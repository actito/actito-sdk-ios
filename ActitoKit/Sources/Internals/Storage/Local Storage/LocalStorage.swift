...
internal enum LocalStorage {
    ...
    internal static var application: ActitoApplication? {
        get {
            ...
            do {
                ...
                return try decoder.decode(ActitoApplication.self, from: data)
            } catch {
    ...
    internal static var crashReport: ActitoEvent? {
        ...
        set {
            ...
            do {
                let data = try JSONEncoder.actito.encode(event)
